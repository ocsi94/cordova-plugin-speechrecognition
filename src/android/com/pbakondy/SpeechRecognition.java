...
public class SpeechRecognition extends CordovaPlugin {
  ...
  private class SpeechRecognitionListener implements RecognitionListener {
    ...
    public void onError(int errorCode) {
      ...
      // HACK: We swallow these three errors as they're popping up in non-critical
      // situations:
      if (errorCode == SpeechRecognizer.ERROR_SPEECH_TIMEOUT || errorCode == SpeechRecognizer.ERROR_CLIENT
          || errorCode == SpeechRecognizer.ERROR_NO_MATCH || errorCode == SpeechRecognizer.ERROR_RECOGNIZER_BUSY) {
        return;
      }
